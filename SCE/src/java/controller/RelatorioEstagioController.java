 ...
 * @author Aluno
 */
public class RelatorioEstagioController extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    public void prepararOperacao(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        try {
            ...
            RequestDispatcher view = request.getRequestDispatcher("/relataEstagio.jsp");
     ...
     public void confirmarOperacao(HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
        ...
        try {
            ...
            parametros.put("codAluno", Integer.parseInt(request.getParameter("optCodAluno")));
